...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> logIn(BuildContext context, String role) async {
    ...
    try {
      final url = Uri.parse(Constants.apiUrl + '/api/auth/login');
      final response = await http.post(
        url,
        body: json.encode({
          'email': email,
          'password': password,
          'role': role, // Include the role in the request body tra fil fenetre???
        }),
        headers: {
 ...
 FirebaseMessaging messaging = FirebaseMessaging.instance;
  ...
  print(tokenFCM);
  final url1 = Uri.parse(Constants.apiUrl + '/api/users/fcm/'+responseData['userid']);
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Expanded(
                          flex: 1,
                          child: Text(
                            'Continue with email for sign in',
                        ...
                        Expanded(
                          ...
                          child: Column(
                            children: [
                              InkWell(
                                  onTap: () async {
                                    await logIn(context, selectedRole);
                                  },
